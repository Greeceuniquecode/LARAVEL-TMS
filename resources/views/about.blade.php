...
@section("content")
<div>
    <div class=" text-5xl text-center text-blue-400 underline font-extrabold mx-auto">
        <h1>About LimitlessTMS</h1>
    </div>
    <div class="text-center font-semibold text-xl underline text-gray-400">
        
            <h2>"Where trust never gets broken"</h2>
    </div>
    <div>
        <img class="relative top-80  h-90 bg-gray-100" src="http://127.0.0.1:8000/images/tmsfake.png" alt="ex1">
    ...
    <div class="p-4 border-2 mt-4 rounded-xl w-1/2  mx-auto bg-linear-to-t from-blue-400 to-white  font-semibold text-2xl text-black-300">
        <p class="text-orange-900">In a world full of distractions, staying productive shouldn’t feel like a challenge—it should feel limitless.</p>
           ...
           <p class="underline font-semibold text-green-900"> 1)🚀 Efficiency Without Limits – Organize, prioritize, and track tasks effortlessly.
            🤝 2)Seamless Collaboration – Work together in real-time, no matter where you are.
               3) ⚡ Smart Automation – Let repetitive tasks take care of themselves.</p>
            <p class="underline font-semibold text-green-900">📊4) Insightful Analytics – Stay on top of progress with data-driven insights.</p>
            
           <p class="text-red-700"> With LimitlessTMS, productivity isn't just a goal—it’s a way of life. Ready to break barriers and take control of your tasks? Your journey to limitless productivity starts here.</p>
    </div>
    <div>
