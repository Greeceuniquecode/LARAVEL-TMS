...
@endsession
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 flex">
            <a href="/employer/add-task"
                class="ml-auto p-2 font-bold bg-green-600 border-b-4 border-white rounded-xl hover:bg-green-800 ease-in-out duration-300 transition-color text-white">
                Add Tasks</a>
        </div>
    </div>
        <!-- Task columns -->
                        ...
                        <a href='/admin/task/{{$task->id}}'>
                            ...
                            <a href="/employer/task/edit/{{ $task->id }}" class=" px-3 text-white rounded-md bg-blue-700 hover:bg-blue-900">
                                Edit
                                                        ...
                                                        <a href="/admin/task/complete/{{ $task->id }}" class=" px-3 text-white rounded-md bg-green-700 hover:bg-green-900">
                                Completed
                            </a>
                            <a href="/admin/task/reject/{{ $task->id }}" class=" px-3 text-white rounded-md bg-red-700 hover:bg-red-900">
                                Reject
                            </a>
                        </div>
                        </div>
