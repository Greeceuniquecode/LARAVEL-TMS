...
<div class="max-w-3xl mx-auto mt-2 mb-12 px-4">
  <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-400 py-2 px-6">
      <h1 class="text-2xl font-bold text-white text-center">Enter Task Details</h1>
    </div>
    
    <!-- Form Body -->
    <div class="p-6">
      <form class="space-y-2" method="POST" action="/employer/update-task" enctype="multipart/form-data">
        @csrf
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <option class="text-blue-600 font-medium" value="progress">In Progress</option>
